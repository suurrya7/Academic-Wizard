...
const subjects = [
    ...
    'Law', 'Nursing', 'Engineering', 'Computer Science', 'Psychology', 'Sociology'
];
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {subjects.map((subject, index) => (
                        <motion.div
                            ...
                            className="px-8 py-10 border border-glass-border rounded-xl text-center group cursor-none"
                        >
                    ...
                    >
                        <span className="text-xs font-heading tracking-widest uppercase text-accent-gold" style={{ color: 'var(--accent-gold)' }}>& Many More</span>
                    </motion.div>
                </div>
            </div>
        </section>
