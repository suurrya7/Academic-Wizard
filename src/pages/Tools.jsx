...
const toolsData = [
    {
        ...
        icon: BookOpen,
        image: "/images/tools/citation-generator.webp",
    ...
    },
    {
        ...
        icon: SpellCheck,
        image: "/images/tools/grammar-checker.webp",
    ...
    },
    {
        ...
        icon: ShieldAlert,
        image: "/images/tools/ai-detector.webp",
        slug: "ai-detector",
    },
    {
        ...
        icon: Sparkles,
        image: "/images/tools/ai-humanizer.webp",
        slug: "ai-humanizer",
    }
];
                        ...
                        >
                            <div className="w-full lg:w-1/3">
                                <Link to={`/tools/${tool.slug}`} className="block group">
                                    <div 
                                        className="glass-card p-4 flex items-center justify-center aspect-square border-accent-gold/20 group-hover:border-accent-gold/50 transition-colors duration-500 rounded-2xl overflow-hidden relative" 
                                        style={{ borderColor: 'rgba(212, 175, 55, 0.2)' }}
                                    >
                                        <div className="absolute inset-0 bg-bg-secondary w-full h-full z-0 overflow-hidden">
                                            <img src={tool.image} alt={tool.title} className="w-full h-full object-cover mix-blend-luminosity opacity-80 group-hover:scale-110 transition-transform duration-500" />
                                        </div>
                                        <div className="absolute top-4 left-4 glass-card p-3 rounded-xl border-accent-gold/30 backdrop-blur-md z-10">
                                            <tool.icon size={24} className="text-accent-gold" style={{ color: 'var(--accent-gold)' }} />
                                        </div>
                                    </div>
                                </Link>
                            </div>
