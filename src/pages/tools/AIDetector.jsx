...
const AIDetector = () => {
    ...
    return (
        <div className="page-ai-detector">
            <Helmet>
                <title>Linguistic AI Text Detector | Academic Wizard</title>
                <meta name="description" content="Instantly analyze your essays and papers for AI footprints. Detect perplexity, sentence uniformity, and AI-typical buzzwords." />
